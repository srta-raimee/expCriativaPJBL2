...
def reg_sens():
    ...
    return fk.redirect(fk.url_for('render.listar', nome=nome, descricao=descricao, tipo=tipo, limite_proximidade=limite_proximidade)) # vai redirecionar para a função de renderização da página "listar"
